...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, alpha_long, is_release, docs) -> structs.CarParams:
    ...
    ret.smoothSteer.maxSteeringAngle = params.get("KisaMaxSteeringAngle") or 90
    ret.smoothSteer.maxDriverAngleWait = params.get("KisaMaxDriverAngleWait") or 0.002
    ret.smoothSteer.maxSteerAngleWait = params.get("KisaMaxSteerAngleWait") or 0.001
    ret.smoothSteer.driverAngleWait = params.get("KisaDriverAngleWait") or 0.001
